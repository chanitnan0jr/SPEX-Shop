      ...
      <div className="relative z-10 text-center space-y-8 max-w-2xl px-4">
        ...
        >
          <div className="flex items-center justify-center">
            <div className="h-20 w-20 rounded-[2.5rem] bg-sky-500/10 border border-sky-500/20 flex items-center justify-center">
              <Settings className="h-10 w-10 text-sky-500 animate-spin-slow" />
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <h2 className="text-4xl md:text-6xl font-black text-slate-950 dark:text-white uppercase tracking-tighter leading-none">
              Console <span className="text-sky-500">Locked</span>
            </h2>
            <p className="text-sm font-medium text-slate-500 dark:text-slate-400 max-w-md mx-auto">
              Our engineering team is currently hard-wiring the advanced configuration module. Return shortly to customize your platform experience.
            </p>
          </div>
        </motion.div>
        ...
        >
          <Link 
            href="/"
            className="group relative flex items-center gap-4 rounded-3xl bg-slate-950 dark:bg-white px-10 py-5 text-sm font-black uppercase tracking-widest text-white dark:text-slate-950 shadow-2xl shadow-sky-500/10 transition-all hover:-translate-y-1 active:translate-y-0"
          >
